...
//  php require "nav.php" ;
 ...
 ?>
    ...
    <div class="container my-5">
        <form action="User Registration 1.php" method="post" onsubmit="return valid()">
...
<div class="container my-5">
<a href="User Login 1.php"><button type="submit" class="btn btn-primary col-md-6">Click Here to go Login Page</button></a>
</div>
